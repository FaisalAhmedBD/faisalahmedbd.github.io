...
import '../styles/carrer-objectives.scss'
export default function CarrerObjectives() {
    return (
        <div className="container" id="carrer-objectives">
            <div className="row carrer-objectives">
